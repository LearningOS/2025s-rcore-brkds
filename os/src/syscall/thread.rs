...
pub fn sys_thread_create(entry: usize, arg: usize) -> isize {
    ...
    while process_inner.tasks.len() < new_task_tid + 1 {
        ...
        process_inner.mutex_matrix[0].push(vec![]);
        process_inner.mutex_matrix[1].push(vec![]);
        process_inner.semaphore_matrix[0].push(vec![]);
        process_inner.semaphore_matrix[1].push(vec![]);
